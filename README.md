...
* 5.  **domain_df_pure.Rds** contains domain specifications compiled from the `Pfam` tool.  
* 6.  Subcellular locations of each protein is in the file named **subcellusr_location_df_pure.Rds**, the information is retrieved from the database called `COMPARTMENTS`.
