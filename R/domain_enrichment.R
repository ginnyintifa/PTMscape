...
#' Analyse cross talk events in domains.
#'
...
#' @param cross_mod A string indicating the crosstalk modification.
#' @param anchor_mapped_df_Rds An Rds file containing the achor window score file with domain mapped(generated by PTM_domain_mapping_enrichment())
#' @param cross_mapped_df_Rds An Rds file containing the cross window score file with domain mapped(generated by PTM_domain_mapping_enrichment())
#' @param output_label The string to tag the output files.
#' @import stringr pryr dplyr magrittr qvalue data.table
#' @export
#' @examples
...
calculate_tbt_two_ptms = function(distance = 5,
                                  anchor_mod, 
                                  cross_mod,
